...
# Form implementation generated from reading ui file 'ChatVideoInterface.ui'
#
...
class Ui_Interface_Video(object):
    def setupUi(self, Interface_Video):
        Interface_Video.setObjectName("Interface_Video")
        Interface_Video.resize(900, 600)
        self.NavigationBar = QtWidgets.QWidget(Interface_Video)
        ...
        self.ToolsBar = QtWidgets.QFrame(Interface_Video)
        ...
        self.VideoShowArea = QtWidgets.QScrollArea(Interface_Video)
        self.VideoShowArea.setGeometry(QtCore.QRect(0, 80, 901, 521))
        self.VideoShowArea.setWidgetResizable(True)
        self.VideoShowArea.setObjectName("VideoShowArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 899, 519))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.VideoShowArea.setWidget(self.scrollAreaWidgetContents)

        self.retranslateUi(Interface_Video)
        QtCore.QMetaObject.connectSlotsByName(Interface_Video)

    def retranslateUi(self, Interface_Video):
        _translate = QtCore.QCoreApplication.translate
        Interface_Video.setWindowTitle(_translate("Interface_Video", "聊天视频"))
        self.button_back.setText(_translate("Interface_Video", "<"))
        self.titleText.setText(_translate("Interface_Video", "聊天视频"))
        self.lineEdit_year.setText(_translate("Interface_Video", "2024"))
        self.lineEdit_month.setText(_translate("Interface_Video", "03"))
        self.lineEdit_day.setText(_translate("Interface_Video", "01"))
        self.button_filter.setText(_translate("Interface_Video", "按日"))
